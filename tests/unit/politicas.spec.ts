...
import { EstoqueAbaixoDoMinimo } from '#modulos/estoque/dominio/eventos/estoque-abaixo-do-minimo'
import { PagamentoConfirmado } from '#modulos/pagamento/dominio/eventos/pagamento-confirmado'
